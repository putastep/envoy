...
Http::FilterFactoryCb CacheCustomFilterFactory::createFilterFactoryFromProtoTyped(
  ...
  auto cache_manager = std::make_shared<CacheManager>(proto_config.max_entries_per_host());
...
REGISTER_FACTORY(CacheCustomFilterFactory, Server::Configuration::NamedHttpFilterConfigFactory);
